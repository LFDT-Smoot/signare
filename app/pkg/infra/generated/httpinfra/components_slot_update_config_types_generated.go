...
type SlotUpdateConfig struct {
	Meta *ResourceMetaUpdate   `json:"meta"`
	Spec *SlotUpdateConfigSpec `json:"spec"`
}

// ValidateWith check whether SlotUpdateConfig is valid
func (data SlotUpdateConfig) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta == nil {
...
func (data *SlotUpdateConfig) SetDefaults() {
