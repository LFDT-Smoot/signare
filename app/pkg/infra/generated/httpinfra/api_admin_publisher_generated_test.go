...
// Test_PublishAdminSlotsUpdateConfig_Success test the PublishAdminSlotsUpdateConfig happy path
func Test_PublishAdminSlotsUpdateConfig_Success(t *testing.T) {
	http := httpinfra.ProvideHTTPRouter()
	err := generatedHTTPInfra.PublishAdminSlotsUpdateConfig(http, generatedHTTPInfra.DefaultAdminAPIHTTPHandler{})
	require.NoError(t, err)
}
